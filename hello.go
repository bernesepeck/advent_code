...
func getInput() string {
	return `14gxqgqsqqbxfpxnbccjc33eight
	eight2sevenkl
...
func firstProblem() {
	numbersToSum := []int{}
	for _, line := range strings.Split(strings.TrimRight(getInput(), "\n"), "\n") {
		numbers := []rune{}
		...
		stringNumber := string(numbers[0]) + string(numbers[len(numbers)-1])
		i, _ := strconv.Atoi(stringNumber)
		intVar := i
		numbersToSum = append(numbersToSum, intVar)
	}
	println(sum(numbersToSum))
